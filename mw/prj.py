...
def get_prj(prj_id):
  ...
  """
  url_items = 'https://tydbdq3mn5.execute-api.ap-northeast-1.amazonaws.com/V1/prj'
  headers = {'Authorization': 'Bearer {}'.format("hogehoge")}
  r_get = requests.get(url_items + '/' + prj_id, headers=headers)
  return r_get.json()
  # return {
  #   'prj_id': 'prjid0001',
